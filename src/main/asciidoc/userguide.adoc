...
of the JSR. The Java 8 based version basically only adds support for specific Java 8 related aspects and
ensures that Java8 based implementation are backward compatible with Java7 based implementations as
well.

Additionally you should of course also include the implementation to test:
...
*****************************************************************************************
**** JSR 354 - Money & Currency, Technical Compatibility Kit - Java 7, version 1.0
*****************************************************************************************
...
JSR 354 TCK - Java 7, version 1.0 Summary
------------------------------------------
